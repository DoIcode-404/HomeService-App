...
import 'package:client/data/helper/date_time_format.dart';
import 'package:client/modules/categories/components/custom_calendar_card.dart';
import 'package:client/modules/categories/components/date_card.dart';
import 'package:client/modules/categories/components/time_select_card.dart';
...
class ServiceDetailSheet extends StatefulWidget {
  const ServiceDetailSheet({super.key});
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CustomHeaderText(text: 'Select your Date & Time?', fontSize: 18),
              const Spacer(),
              CustomIconButton(
                onTap: () {
                  Get.back();
          ...
          isTime ? SizedBox(height: 20) : const SizedBox(),
          AnimatedCrossFade(
