  ...
  Widget build(BuildContext context) {
    ...
    return chat.isSender
        ? Row(
          ...
          children: [
            CircleAvatar(backgroundImage: AssetImage(AppAssets.kLogo)),
            SizedBox(width: 10),
            Expanded(
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(chat.message, style: AppTypography.kLight15),
                  ),
                ],
              ),
            ),
        ...
        : Row(
          ...
          children: [
            ...
            SizedBox(width: 10),
            CircleAvatar(backgroundImage: AssetImage(AppAssets.kProfilePic)),
            SizedBox(width: 10),
          ],
        );
  }
